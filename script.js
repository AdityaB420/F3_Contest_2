...
const API_KEY = "cadaaa16a5ca4869bab0c767e0089665";
...
fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${position.coords.latitude}&lon=${position.coords.longitude}&format=json&apiKey=b14de122702f4ac4a1ac81e15ffce107`)
.then(resp => resp.json())
.then((result) => {
